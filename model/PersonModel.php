	 ...
	 public function getPerson()
   {
    ...
    return $response;
	 ...
	 public function addPerson()
	  {  
       try{  $qry1="INSERT INTO person(fname,lname,dob,mobile_no,gender,house_no,street,city,district,state,pincode,email) values(:fname,:lname,:dob,:mobile_no,:gender,:house_no,:street,:city,:district,state,:pincode,:email)";
