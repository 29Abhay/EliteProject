...
public function addbatch(){
       ...
       $stmt->bindParam(":start_date",$start_date);
        ...
        $data=$stmt->execute();
         ...
         {
            $response=array("status"=>0,"status_message"=>"error in inserting data ");
          ...
          if ($e->getCode()==23000)
       {
        $response=array("status"=>0,"status_message"=>"duplicate entry");
         ...
         {
            $response=array("status"=>0,"status_message"=>"error in inserting data or may be incorrect entries");
